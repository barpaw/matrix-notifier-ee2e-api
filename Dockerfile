...
RUN pip install --prefix="/python-libs" --no-warn-script-location FastAPI
RUN pip install --prefix="/python-libs" --no-warn-script-location pydantic
RUN pip install --prefix="/python-libs" --no-warn-script-location uvicorn
